...
export default class Player {
  constructor(scene, x, y) {
    ...
    this.sprite = scene.matter.add.sprite(0, 0, "player", 0).setDepth(15);
  ...
  update() {
	...
	const canJump1 = this.isTouching.right;
	const canJump2 = this.isTouching.left;
    ...
    if (velocity.x > 6) this.sprite.setVelocityX(6);
    else if (velocity.x < -6) this.sprite.setVelocityX(-6);
    ...
    if (isJumpKeyDown && this.canJump && isOnGround || isJumpKeyDown && this.canJump && canJump1 || isJumpKeyDown && this.canJump && canJump2 || isJumpKeyDown && DelayTime > 0 && this.canJump) {
